...
(define file-shift   (+ 3 char-shift))
(define socket-shift (+ 3 char-shift))

(define imm-mask         #b111)
(define ptr-mask         #b111)
(define mask-int        #b1111)
(define mask-char      #b11111)
(define mask-file   #b11111111)
(define mask-socket #b11111111)
...
(define type-file   #b01111000)
(define type-socket #b11111000)
